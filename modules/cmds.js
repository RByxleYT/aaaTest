    ...
    try {
      ...
      if (["h", "help", "cmd"].includes(cmd)) {
        return message.channel.send(new Discord.MessageEmbed()
          ...
          .addField(`\`add\``, "> *[Invite](https://discord.com/api/oauth2/authorize?client_id=878078582423953448&permissions=8&scope=bot) the Bot!*", true)
          ...
          .addField("\u200b", "\u200b")
          .addField(`\`setup\` --> Follow steps`, "> *Sets up 1 Application System out of 10, with maximum of 24 Questions!*\n> *You can also edit that by picking edit afterwards*")
        ...
        cpuStat.usagePercent(function (e, percent, seconds) {
          if (e) {
            ...
            const botinfo = new Discord.MessageEmbed()
              .setAuthor(client.user.tag + " Information", client.user.displayAvatarURL(), "https://discord.com/api/oauth2/authorize?client_id=878078582423953448&permissions=8&scope=bot") 
              ...
              .addField("• Developer", `\`\`\`yml\nName: RByxle#9999 [746275512145674351]\`\`\``)
              .addField("• Important Links", `**[Invite Link](https://discord.com/api/oauth2/authorize?client_id=878078582423953448&permissions=8&scope=bot)\**`)
              .setFooter("Coded by:    RByxle#9999", client.user.displayAvatarURL());
        ...
        return message.channel.send(new Discord.MessageEmbed()
          .setColor("#7883ff")
          .setURL("https://discord.com/api/oauth2/authorize?client_id=878078582423953448&permissions=8&scope=bot")
          .setTitle("❤ | Thanks for every invite!")
          .setDescription(`[Click here to invite me, thanks (Invite me!)](https://discord.com/api/oauth2/authorize?client_id=878078582423953448&permissions=8&scope=bot)\n`)
          .setFooter(`${client.user.username}`, client.user.displayAvatarURL())
        )
        return;
      }
...
*React with the Right Emoji according to the Right action*`).setFooter(`${client.user.username}`, client.user.displayAvatarURL())
            )
            try {
              tempmsg.react("1️⃣")
              tempmsg.react("2️⃣")
            ...
            await tempmsg.awaitReactions(filter, {
              ...
              .then(async collected => {
                ...
                if (reaction.emoji.name === "1️⃣") {
                    ...
                    let pickmsg = await tempmsg.edit(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("#7883ff").setTitle("What do you want me to do?").setDescription("1️⃣ === I will create a Channel for you\n2️⃣ === You can pick your own Channels!").setFooter(`${client.user.username}`, client.user.displayAvatarURL()))
                    ...
                    if (errored)
                      return message.channel.send(new Discord.MessageEmbed().setColor("RED").setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setTitle(":x: ERROR | TIME RAN OUT / INVALID INPUT | cancelled").setDescription("```" + e.message + "```")).then(msg => msg.delete({
                        timeout: 7500
                      }))
    
                    async function setup_with_channel_creation() {
                    
                        message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("#7883ff").setAuthor("Setting up...", "https://miro.medium.com/max/1600/1*e_Loq49BI4WmN7o9ItTADg.gif").setFooter(`${client.user.username}`, client.user.displayAvatarURL()))
                        message.guild.channels.create("📜 || Applications", {
                          type: "category",
                        }).then(ch => {
                          ch.guild.channels.create("📋|applications", {
                            type: "text",
                          ...
                          ch.guild.channels.create("✅|apply-here", {
                            ...
                            let embed = new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL())
                              .setColor("#7883ff")
                              .setFooter(`${client.user.username}`, client.user.displayAvatarURL())
                                ...
                                .then(something => {
                                  message.channel.send(embed.setTitle("What should be the embed TEXT?").setDescription("Like what do u want to have listed in the Embed?")).then(msg => {
                                    msg.channel.awaitMessages(m => m.author.id === userid, {
                                      ...
                                      let setupembed = new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL())
                                        .setColor(color)
                                        .setDescription(desc)
                                      ...
                                      function ask_which_qu() {
                                        counter++;
                                        if (counter === 25) {
                                          message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("RED").setAuthor("You reached the maximum amount of Questions!", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/facebook/65/cross-mark_274c.png"))
                                          return ask_addrole();
                                        }
                                        ...
                                        message.channel.send(embed.setTitle(`Do you want to add a Role, when some1 applies?`).setDescription("Enter `no`, if not\n\nJust ping the Role")).then(msg => {
                                          msg.channel.awaitMessages(m => m.author.id === userid, {
                                            ...
                                            if (collected.first().content.toLowerCase() === "no") {
                                              ...
                                              if (!message.guild.me.roles) return message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("RED").setDescription("Make sure that the Role is under me!").setAuthor(":x: ERROR | Could not Access the Role", message.author.displayAvatarURL({
                                                dynamic: true
                                              })))
                    ...
                    async function setup_without_channel_creation() {
                        ...
                        let applychannel;
                        let f_applychannel;
                        pickmsg = await message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("#7883ff").setTitle("What should be the Channel, where someone should __start__ the Application?").setDescription("Please ping the Channel #channel").setFooter(`${client.user.username}`, client.user.displayAvatarURL()))
                        ...
                        pickmsg = await message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("#7883ff").setTitle("What should be the Channel, where the __finished__ Application should be sent?").setDescription("Please ping the Channel #channel").setFooter(`${client.user.username}`, client.user.displayAvatarURL()))
                            ...
                            function ask_addrole() {
                              message.channel.send(embed.setTitle(`Do you want to add a Role, when some1 applies?`).setDescription("Enter `no`, if not\n\nJust ping the Role")).then(msg => {
                                msg.channel.awaitMessages(m => m.author.id === userid, {
                                  ...
                                  if (collected.first().content.toLowerCase() === "no") {
                                    return message.channel.send(`YOUR APPLICATION SYSTEM IS READY TO BE USED: ${applychannel}\n`);
                                  } else {
                                    let role = collected.first().mentions.roles.map(role => role.id).join(" ");
                                    if (!role) return message.channel.send(new Discord.MessageEmbed()
                                              .setFooter(`${client.user.username}`, client.user.displayAvatarURL())
                  ...
                  let pickmsg = await tempmsg.edit(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("RED").setTitle("What do you want me to do?")
                  .setDescription(
    `
    ...
    `
                  ...
                  await pickmsg.awaitReactions((reaction, user) => user.id === message.author.id , {
                        ...
                        switch (args) {
                          case "acceptmsg":
                           {
                              message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("#7883ff").setAuthor("What should be the new accept message?", message.author.displayAvatarURL({
                                dynamic: true
                              }))).then(msg => {
                                msg.channel.awaitMessages(m => m.author.id === message.author.id, {
                                  ...
                                  return message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("GREEN").setAuthor("Successfully changed the ACCEPT MESSAGE!", message.author.displayAvatarURL({
                                    dynamic: true
                                  })))
                                }).catch(error => {
                          ...
                          case "acceptrole":
                            {
                              message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("#7883ff").setAuthor("What should be the new accept Role, which will be granted when the User got accepted?", message.author.displayAvatarURL({
                                dynamic: true
                              }))).then(msg => {
                                msg.channel.awaitMessages(m => m.author.id === message.author.id, {
                                  max: 1,
                                  ...
                                  if (guildrole.rawPosition <= botrole.rawPosition) {
                                    ...
                                    return message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("GREEN").setAuthor("Successfully changed the ACCEPT ROLE!", message.author.displayAvatarURL({
                                      dynamic: true
                                    })))
                                  } else {
                                    return message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("RED").setDescription("Make sure that the Role is under me!").setAuthor(":x: ERROR | Could not Access the Role", message.author.displayAvatarURL({
                                      dynamic: true
                                    })))
                                  }
                                }).catch(error => {
                          ...
                          case "denymsg":
                            {
                              message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("#7883ff").setAuthor("What should be the new deny message?", message.author.displayAvatarURL({
                                dynamic: true
                              }))).then(msg => {
                                msg.channel.awaitMessages(m => m.author.id === message.author.id, {
                                  max: 1,
                                  ...
                                  return message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("GREEN").setAuthor("Successfully changed the DENY MESSAGE!", message.author.displayAvatarURL({
                                    dynamic: true
                                  })))
                                }).catch(error => {
                          ...
                          case "ticketmsg":
                            {
                              message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("#7883ff").setAuthor("What should be the new Ticket message? | {user} pings the User", message.author.displayAvatarURL({
                                dynamic: true
                              }))).then(msg => {
                                msg.channel.awaitMessages(m => m.author.id === message.author.id, {
                                  max: 1,
                                  ...
                                  return message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("GREEN").setAuthor("Successfully changed the TICKET MESSAGE!", message.author.displayAvatarURL({
                                    dynamic: true
                                  })))
                                }).catch(error => {
                          ...
                          case "emojione":
                            {
                              ...
                              switch (type) {
                                case "message":
                                  {
                                    message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("#7883ff").setAuthor("What should be the new accept message for emoji one?", message.author.displayAvatarURL({
                                      dynamic: true
                                    }))).then(msg => {
                                      msg.channel.awaitMessages(m => m.author.id === message.author.id, {
                                        max: 1,
                                        ...
                                        return message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("GREEN").setAuthor("Successfully changed the ACCEPT MESSAGE for emoji one!", message.author.displayAvatarURL({
                                          dynamic: true
                                        })))
                                      }).catch(error => {
                                ...
                                case "setrole":
                                  {
                                    message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("#7883ff").setAuthor("What should be the new accept Role, which will be granted when the User got accepted for emoji one?", message.author.displayAvatarURL({
                                      dynamic: true
                                    }))).then(msg => {
                                      msg.channel.awaitMessages(m => m.author.id === message.author.id, {
                                        max: 1,
                                        ...
                                        if (guildrole.rawPosition <= botrole.rawPosition) {
                                          ...
                                          return message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("GREEN").setAuthor("Successfully changed the ACCEPT ROLE for emoji one!", message.author.displayAvatarURL({
                                            dynamic: true
                                          })))
                                        } else {
                                          return message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("RED").setDescription("Make sure that the Role is under me!").setAuthor(":x: ERROR | Could not Access the Role", message.author.displayAvatarURL({
                                ...
                                case "delrole":
                                  {
                                    ...
                                    return message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("GREEN").setAuthor("Successfully deleted the ACCEPT ROLE for emoji one!", message.author.displayAvatarURL({
                                      dynamic: true
                                    })))
                                  }
                                  break;
                                  ...
                                  case "setimage":
                                    {
                                      try {
                                        ...
                                        return message.channel.send(new Discord.MessageEmbed()
                                          .setTitle(":x: ERROR | Something went wrong, please contact: `RByxle#9999`")
                                          .setColor("RED")
                          ...
                          case "emojitwo":
                            {
                              ...
                              switch (type) {
                                case "message":
                                  {
                                    message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("#7883ff").setAuthor("What should be the new accept message for emoji two?", message.author.displayAvatarURL({
                                      dynamic: true
                                    }))).then(msg => {
                                      msg.channel.awaitMessages(m => m.author.id === message.author.id, {
                                        max: 1,
                                        ...
                                        return message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("GREEN").setAuthor("Successfully changed the ACCEPT MESSAGE for emoji two!", message.author.displayAvatarURL({
                                          dynamic: true
                                        })))
                                      }).catch(error => {
                                ...
                                case "setrole":
                                  {
                                    message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("#7883ff").setAuthor("What should be the new accept Role, which will be granted when the User got accepted for emoji two?", message.author.displayAvatarURL({
                                      dynamic: true
                                    }))).then(msg => {
                                      msg.channel.awaitMessages(m => m.author.id === message.author.id, {
                                        max: 1,
                                        ...
                                        if (guildrole.rawPosition <= botrole.rawPosition) {
                                          ...
                                          return message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("GREEN").setAuthor("Successfully changed the ACCEPT ROLE for emoji two!", message.author.displayAvatarURL({
                                            dynamic: true
                                          })))
                                        } else {
                                          return message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("RED").setDescription("Make sure that the Role is under me!").setAuthor(":x: ERROR | Could not Access the Role", message.author.displayAvatarURL({
                                ...
                                case "delrole":
                                  {
                                    ...
                                    return message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("GREEN").setAuthor("Successfully deleted the ACCEPT ROLE for emoji two!", message.author.displayAvatarURL({
                                      dynamic: true
                                    })))
                                  }
                                  break;
                          ...
                          case "emojithree":
                            {
                              ...
                              switch (type) {
                                case "message":
                                  {
                                    message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("#7883ff").setAuthor("What should be the new accept message for emoji three?", message.author.displayAvatarURL({
                                      dynamic: true
                                    }))).then(msg => {
                                      msg.channel.awaitMessages(m => m.author.id === message.author.id, {
                                        max: 1,
                                        ...
                                        return message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("GREEN").setAuthor("Successfully changed the ACCEPT MESSAGE for emoji three!", message.author.displayAvatarURL({
                                          dynamic: true
                                        })))
                                      }).catch(error => {
                                ...
                                case "setrole":
                                  {
                                    message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("#7883ff").setAuthor("What should be the new accept Role, which will be granted when the User got accepted for emoji three?", message.author.displayAvatarURL({
                                      dynamic: true
                                    }))).then(msg => {
                                      msg.channel.awaitMessages(m => m.author.id === message.author.id, {
                                        max: 1,
                                        ...
                                        if (guildrole.rawPosition <= botrole.rawPosition) {
                                          ...
                                          return message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("GREEN").setAuthor("Successfully changed the ACCEPT ROLE for emoji three!", message.author.displayAvatarURL({
                                            dynamic: true
                                          })))
                                        } else {
                                          return message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("RED").setDescription("Make sure that the Role is under me!").setAuthor(":x: ERROR | Could not Access the Role", message.author.displayAvatarURL({
                                ...
                                case "delrole":
                                  {
                                    ...
                                    return message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("GREEN").setAuthor("Successfully deleted the ACCEPT ROLE for emoji three!", message.author.displayAvatarURL({
                                      dynamic: true
                                    })))
                                  }
                                  break;
                          ...
                          case "emojifour":
                            {
                              ...
                              switch (type) {
                                case "message":
                                  {
                                    message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("#7883ff").setAuthor("What should be the new accept message for emoji four?", message.author.displayAvatarURL({
                                      dynamic: true
                                    }))).then(msg => {
                                      msg.channel.awaitMessages(m => m.author.id === message.author.id, {
                                        max: 1,
                                        ...
                                        return message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("GREEN").setAuthor("Successfully changed the ACCEPT MESSAGE for emoji four!", message.author.displayAvatarURL({
                                          dynamic: true
                                        })))
                                      }).catch(error => {
                                ...
                                case "setrole":
                                  {
                                    message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("#7883ff").setAuthor("What should be the new accept Role, which will be granted when the User got accepted for emoji four?", message.author.displayAvatarURL({
                                      dynamic: true
                                    }))).then(msg => {
                                      msg.channel.awaitMessages(m => m.author.id === message.author.id, {
                                        max: 1,
                                        ...
                                        if (guildrole.rawPosition <= botrole.rawPosition) {
                                          ...
                                          return message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("GREEN").setAuthor("Successfully changed the ACCEPT ROLE for emoji four!", message.author.displayAvatarURL({
                                            dynamic: true
                                          })))
                                        } else {
                                          return message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("RED").setDescription("Make sure that the Role is under me!").setAuthor(":x: ERROR | Could not Access the Role", message.author.displayAvatarURL({
                                ...
                                case "delrole":
                                  {
                                    ...
                                    return message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("GREEN").setAuthor("Successfully deleted the ACCEPT ROLE for emoji four!", message.author.displayAvatarURL({
                                      dynamic: true
                                    })))
                                  }
                                  break;
                          ...
                          case "emojifive":
                            {
                              ...
                              switch (type) {
                                case "message":
                                  {
                                    message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("#7883ff").setAuthor("What should be the new accept message for emoji five?", message.author.displayAvatarURL({
                                      dynamic: true
                                    }))).then(msg => {
                                      msg.channel.awaitMessages(m => m.author.id === message.author.id, {
                                        max: 1,
                                        ...
                                        return message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("GREEN").setAuthor("Successfully changed the ACCEPT MESSAGE for emoji five!", message.author.displayAvatarURL({
                                          dynamic: true
                                        })))
                                      }).catch(error => {
                                ...
                                case "setrole":
                                  {
                                    message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("#7883ff").setAuthor("What should be the new accept Role, which will be granted when the User got accepted for emoji five?", message.author.displayAvatarURL({
                                      dynamic: true
                                    }))).then(msg => {
                                      msg.channel.awaitMessages(m => m.author.id === message.author.id, {
                                        max: 1,
                                        ...
                                        if (guildrole.rawPosition <= botrole.rawPosition) {
                                          ...
                                          return message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("GREEN").setAuthor("Successfully changed the ACCEPT ROLE for emoji five!", message.author.displayAvatarURL({
                                            dynamic: true
                                          })))
                                        } else {
                                          return message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("RED").setDescription("Make sure that the Role is under me!").setAuthor(":x: ERROR | Could not Access the Role", message.author.displayAvatarURL({
                                ...
                                case "delrole":
                                  {
                                    ...
                                    return message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("GREEN").setAuthor("Successfully deleted the ACCEPT ROLE for emoji five!", message.author.displayAvatarURL({
                                      dynamic: true
                                    })))
                                  }
                                  break;
                                case "delimage":
                                  {
                                    ...
                                    return message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("GREEN").setAuthor("Successfully deleted the ACCEPT IMAGE for emoji five!", message.author.displayAvatarURL({
                                      dynamic: true
                                    })))
                                  }
                                  case "setimage":
                          ...
                          case "editquestion":
                            {
                              ...
                              let embed = new Discord.MessageEmbed()
                                ...
                                .setColor("#7883ff")
                                .setTitle("Current Questions") //RByxle#9999
                              ...
                              msg.channel.awaitMessages(m => m.author.id === message.author.id, {
                                ...
                                if (arr.length >= Number(quindex)) {
                                  message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("#7883ff").setAuthor("What should be the new Question?", message.author.displayAvatarURL({
                                    dynamic: true
                                  }))).then(msg => {
                                    msg.channel.awaitMessages(m => m.author.id === message.author.id, {
                                      max: 1,
                                      ...
                                      let new_embed = new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL())
                                        .setColor("#7883ff")
                                        .setTitle("NEW Questions") //RByxle#9999
                                  ...
                                  message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("RED").setAuthor("It seems, that this Question does not exist! Please retry! Here are all Questions:", message.author.displayAvatarURL({
                                    dynamic: true
                                  })))
                          ...
                          case "addquestion":
                            {
                              ...
                              .setDescription(`Simply send the Question into the Text`)
                                ...
                                msg.channel.awaitMessages(m => m.author.id === message.author.id, {
                                  ...
                                  message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("GREEN").setAuthor("Successfully added your Question!", message.author.displayAvatarURL({
                                    dynamic: true
                                  })))
                                  Questions = apply_for_here.get(message.guild.id, "QUESTIONS");
                                  let embed = new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL())
                          ...
                          case "finishedapplychannel":
                            try {
                              ...
                              let userid = message.author.id;
                              pickmsg = await message.channel.send(new Discord.MessageEmbed().setFooter(`${client.user.username}`, client.user.displayAvatarURL()).setColor("#7883ff").setTitle("What should be the Channel, where the __finished__ Applications will be sent?").setDescription("Please ping the Channel #channel").setFooter(`${client.user.username}`, client.user.displayAvatarURL()))
                          ...
                          case "last_verify":
                            {
                              ...
                              let embed = new Discord.MessageEmbed()
                                ...
                                .setColor("#7883ff")
                                .setTitle(`${apply_for_here.get(message.guild.id, "last_verify") ? "Enabled Last Verification": "Disabled Last Verification"}`) //RByxle#9999
                                .setDescription(`${apply_for_here.get(message.guild.id, "last_verify") ? "I will now ask the User a last Time if he really wanna apply for the Server": "I will not ask the User"}`) //RByxle#9999
